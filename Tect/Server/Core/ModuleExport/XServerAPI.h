...
XServerAPI XServer::TimerID Timer_AddTimer(unsigned int delay, XServer::TimeoutCallback callback);
XServerAPI XServer::TimerID Timer_AddRepeatTimer(unsigned int delay, unsigned int interval, XServer::TimeoutCallback callback);
XServerAPI bool Timer_CancelTimer(XServer::TimerID);
